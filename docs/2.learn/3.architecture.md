...
Rocco emits events throughout the request lifecycle via [capitan](https://github.com/zoobz-io/capitan):
...
Type metadata is extracted using [sentinel](https://github.com/zoobz-io/sentinel), which scans struct types at handler creation time.
