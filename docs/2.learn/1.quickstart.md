...
> **Note**: Runtime validation is opt-in. To validate inputs, inject a validator with `WithValidator()`. See [Concepts: Validation](2.concepts.md#validation) for details.
