...
> **Note**: Runtime validation is opt-in. To validate inputs, implement the `Validatable` interface on your types. See [Concepts: Validation](2.concepts.md#validation) for details.
