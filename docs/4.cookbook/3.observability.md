...
Rocco emits lifecycle events via [capitan](https://github.com/zoobz-io/capitan). You hook into these events to build observability.
...
- [capitan Documentation](https://github.com/zoobz-io/capitan) - Event system docs
